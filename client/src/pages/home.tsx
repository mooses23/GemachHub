...
import { Headphones, Mail, Share2, Clock } from "lucide-react";
...
export default function Home() {
  return (
    <>
      {/* Meta tags */}
      <head>
        <title>Baby Banz Earmuffs Gemach - Protecting Babies' Hearing at Celebrations</title>
        <meta name="description" content="Baby Banz Earmuffs Gemach lends noise-cancelling earmuffs to protect infants' hearing at weddings, concerts and celebrations with a $20 refundable deposit." />
        <meta property="og:title" content="Baby Banz Earmuffs Gemach" />
        <meta property="og:description" content="Protecting babies' hearing at celebrations with our lending service. Borrow earmuffs with just a $20 refundable deposit." />
      ...
      {/* Apply for Gemach Section */}
      <section id="apply" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-neutral-800 mb-4">Open a Gemach in Your Community</h2>
