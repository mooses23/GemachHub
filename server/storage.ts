...
export class MemStorage implements IStorage {
  ...
  private initializeDefaultData() {
    ...
    const defaultCityCategories: InsertCityCategory[] = [
      ...
      // Additional US frum communities (NY)
      { name: "Cedarhurst", slug: "cedarhurst", regionId: 1, displayOrder: 21, stateCode: "NY" },
      { name: "Far Rockaway", slug: "far-rockaway", regionId: 1, displayOrder: 22, stateCode: "NY" },
      { name: "Long Beach", slug: "long-beach", regionId: 1, displayOrder: 23, stateCode: "NY" },
      { name: "Kew Gardens Hills", slug: "kew-gardens-hills", regionId: 1, displayOrder: 24, stateCode: "NY" },
      { name: "Riverdale", slug: "riverdale", regionId: 1, displayOrder: 25, stateCode: "NY" },
      { name: "Spring Valley", slug: "spring-valley", regionId: 1, displayOrder: 26, stateCode: "NY" },
      { name: "Wesley Hills", slug: "wesley-hills", regionId: 1, displayOrder: 27, stateCode: "NY" },
      { name: "Pomona", slug: "pomona", regionId: 1, displayOrder: 28, stateCode: "NY" },
      { name: "Suffern", slug: "suffern", regionId: 1, displayOrder: 29, stateCode: "NY" },
      { name: "Kiryas Joel", slug: "kiryas-joel", regionId: 1, displayOrder: 30, stateCode: "NY" },
      // Additional US frum communities (NJ)
      { name: "Englewood", slug: "englewood", regionId: 1, displayOrder: 31, stateCode: "NJ" },
      { name: "Bergenfield", slug: "bergenfield", regionId: 1, displayOrder: 32, stateCode: "NJ" },
      { name: "Fair Lawn", slug: "fair-lawn", regionId: 1, displayOrder: 33, stateCode: "NJ" },
      { name: "Elizabeth", slug: "elizabeth", regionId: 1, displayOrder: 34, stateCode: "NJ" },
      { name: "Linden", slug: "linden", regionId: 1, displayOrder: 35, stateCode: "NJ" },
      { name: "East Brunswick", slug: "east-brunswick", regionId: 1, displayOrder: 36, stateCode: "NJ" },
      // Additional US frum communities (other states)
      { name: "Silver Spring", slug: "silver-spring", regionId: 1, displayOrder: 37, stateCode: "MD" },
      { name: "Washington DC", slug: "washington-dc", regionId: 1, displayOrder: 38, stateCode: "DC" },
      { name: "Pittsburgh", slug: "pittsburgh", regionId: 1, displayOrder: 39, stateCode: "PA" },
      { name: "Allentown", slug: "allentown", regionId: 1, displayOrder: 40, stateCode: "PA" },
      { name: "Scranton", slug: "scranton", regionId: 1, displayOrder: 41, stateCode: "PA" },
      { name: "Boca Raton", slug: "boca-raton", regionId: 1, displayOrder: 42, stateCode: "FL" },
      { name: "Hollywood", slug: "hollywood", regionId: 1, displayOrder: 43, stateCode: "FL" },
      { name: "North Miami Beach", slug: "north-miami-beach", regionId: 1, displayOrder: 44, stateCode: "FL" },
      { name: "Atlanta", slug: "atlanta", regionId: 1, displayOrder: 45, stateCode: "GA" },
      { name: "Memphis", slug: "memphis", regionId: 1, displayOrder: 46, stateCode: "TN" },
      { name: "Cincinnati", slug: "cincinnati", regionId: 1, displayOrder: 47, stateCode: "OH" },
      { name: "Columbus", slug: "columbus", regionId: 1, displayOrder: 48, stateCode: "OH" },
      { name: "St. Louis", slug: "st-louis", regionId: 1, displayOrder: 49, stateCode: "MO" },
      { name: "Houston", slug: "houston", regionId: 1, displayOrder: 50, stateCode: "TX" },
      { name: "Dallas", slug: "dallas", regionId: 1, displayOrder: 51, stateCode: "TX" },
      { name: "Denver", slug: "denver", regionId: 1, displayOrder: 52, stateCode: "CO" },
      { name: "Phoenix", slug: "phoenix", regionId: 1, displayOrder: 53, stateCode: "AZ" },
      { name: "Las Vegas", slug: "las-vegas", regionId: 1, displayOrder: 54, stateCode: "NV" },
      { name: "San Diego", slug: "san-diego", regionId: 1, displayOrder: 55, stateCode: "CA" },
      { name: "Seattle", slug: "seattle", regionId: 1, displayOrder: 56, stateCode: "WA" },
      { name: "Brookline / Boston", slug: "brookline-boston", regionId: 1, displayOrder: 57, stateCode: "MA" },
      { name: "Stamford", slug: "stamford", regionId: 1, displayOrder: 58, stateCode: "CT" },
      { name: "New Haven", slug: "new-haven", regionId: 1, displayOrder: 59, stateCode: "CT" },
      { name: "Waterbury", slug: "waterbury", regionId: 1, displayOrder: 60, stateCode: "CT" },
      // Additional Canada communities
      { name: "Thornhill", slug: "thornhill", regionId: 2, displayOrder: 3 },
      { name: "Ottawa", slug: "ottawa", regionId: 2, displayOrder: 4 },
      { name: "Hamilton", slug: "hamilton", regionId: 2, displayOrder: 5 },
      { name: "Winnipeg", slug: "winnipeg", regionId: 2, displayOrder: 6 },
      { name: "Vancouver", slug: "vancouver", regionId: 2, displayOrder: 7 },
      // Additional UK communities
      { name: "Gateshead", slug: "gateshead", regionId: 3, displayOrder: 3 },
      // Additional Europe communities
      { name: "Vienna", slug: "vienna", regionId: 4, displayOrder: 4 },
      { name: "Zurich", slug: "zurich", regionId: 4, displayOrder: 5 },
      { name: "Berlin", slug: "berlin", regionId: 4, displayOrder: 6 },
      { name: "Frankfurt", slug: "frankfurt", regionId: 4, displayOrder: 7 },
      // Additional Israel communities
      { name: "Ramat Beit Shemesh", slug: "ramat-beit-shemesh", regionId: 6, displayOrder: 24, isPopular: true },
      { name: "Tzfat", slug: "tzfat", regionId: 6, displayOrder: 25 },
      { name: "Rechasim", slug: "rechasim", regionId: 6, displayOrder: 26 },
      { name: "Hadera", slug: "hadera", regionId: 6, displayOrder: 27 },
      { name: "Karnei Shomron", slug: "karnei-shomron", regionId: 6, displayOrder: 28 },
      { name: "Efrat", slug: "efrat", regionId: 6, displayOrder: 29 },
      { name: "Migdal HaEmek", slug: "migdal-haemek", regionId: 6, displayOrder: 30 },
      { name: "Ra'anana", slug: "raanana", regionId: 6, displayOrder: 31 },
      { name: "Netanya", slug: "netanya", regionId: 6, displayOrder: 32 },
      { name: "Kiryat Malachi", slug: "kiryat-malachi", regionId: 6, displayOrder: 33 },
    ];
  ...
  private createLocationSync(insertLocation: InsertLocation): Location {
    ...
    const location: Location = { 
      ...
      welcomeSmsSid: null,
      welcomeSmsDeliveredAt: null,
      welcomeWhatsappStatus: null,
      welcomeWhatsappError: null,
      welcomeWhatsappSentAt: null,
      welcomeWhatsappSid: null,
      welcomeWhatsappDeliveredAt: null,
  ...
  async updateContact(id: number, data: Partial<Pick<Contact, 'subject' | 'message' | 'isRead' | 'isArchived' | 'isSpam'>>): Promise<Contact> {
    ...
    const updatedContact: Contact = { ...contact, ...data };
    this.contacts.set(id, updatedContact);
    return updatedContact;
  }
